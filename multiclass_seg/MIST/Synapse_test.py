...
parser.add_argument('--volume_path', type=str,
    default=output_dir,
    help='root dir for test data (.npz files)')
parser.add_argument('--list_dir', type=str,
    default=list_dir,
    help='list dir with test_vol.txt')
parser.add_argument('--dataset', type=str,
                    default=DATASET_BASE_PATH, help='experiment_name')
...
if(args.num_classes == 3):
    classes = ['background','adonoma','hyperplastic']
else:
