...
if __name__ == "__main__":
    ...
    safe_time = current_time.replace(" ", "_").replace(":", "-")
    args.exp = f"run_{safe_time}_{args.exp}"
    snapshot_path = "C:/Users/jaydu/OneDrive/Desktop/python_projects/polpy classification/PraNet-V2/models/{}/{}".format(dataset_name, args.exp)
