...
# # --- MODIFICATION START ---
# # The dotenv library is no longer needed as paths will be passed via argparse.
...
# # --- MODIFICATION START ---
# # Path arguments are now required and must be provided when running the script.
# # The hardcoded defaults have been removed.
...
# parser.add_argument("--batch_size", default=4, type=int, help="batch size") #ori is 12
