...
parser.add_argument("--save_path", default=r"C:\Users\jaydu\OneDrive\Desktop\python_projects\polpy classification\PraNet-V2\multiclass_seg\MERIT\model_pth\ACDC")
parser.add_argument("--n_gpu", default=1)
parser.add_argument("--checkpoint", default=None)
parser.add_argument("--list_dir", default=list_dir) # TODO: replace with actual path
parser.add_argument("--root_dir", default=output_dir) # TODO: replace with actual path (root of ACDC dataset)
parser.add_argument("--volume_path", default=output_dir) # TODO: replace with actual path
...
current_time = datetime.now(pytz.timezone('Asia/Shanghai')).strftime("%Y-%m-%d_%H-%M")
print("The current time is", current_time)
args.exp='run_'+current_time+'_'+args.exp
...
if args.test_save_dir is not None:
    # This line correctly creates the full path to the predictions directory.
    test_save_path = os.path.join(snapshot_path, args.test_save_dir)
    
    # We no longer need to add args.exp again.
